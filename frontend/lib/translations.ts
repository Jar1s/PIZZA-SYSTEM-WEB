...
export const translations = {
  sk: {
    ...
    soups: 'Polievky',
    soupsTitle: 'MORNING AFTER (PO OPICI)',
    soupsSubtitle: '🥫 Zachráni aj po najdivokejšej noci.',
    drinks: 'Nápoje',
    ...
    openingHours: 'Denne 10:00 - 21:30',
    ...
    // Order Statuses
    orderStatusPending: 'Čaká na platbu',
    orderStatusPaid: 'Zaplatené',
    orderStatusPreparing: 'V príprave',
    orderStatusReady: 'Pripravené',
    orderStatusOutForDelivery: 'Na ceste',
    orderStatusDelivered: 'Doručené',
    orderStatusCanceled: 'Zrušené',
    orderStatusPendingDesc: 'Objednávka prijatá',
    orderStatusPaidDesc: 'Platba úspešná',
    orderStatusPreparingDesc: 'Vaša pizza sa pripravuje',
    orderStatusReadyDesc: 'Objednávka je pripravená',
    orderStatusOutForDeliveryDesc: 'Na ceste k vám',
    orderStatusDeliveredDesc: 'Dobrú chuť!',
  ...
  en: {
    ...
    soups: 'Soups',
    soupsTitle: 'MORNING AFTER',
    soupsSubtitle: '🥫 Will save you even after the wildest night.',
    drinks: 'Drinks',
    ...
    orderStatusPendingDesc: 'We received your order',
    orderStatusPaidDesc: 'Payment successful',
    orderStatusPreparingDesc: 'Your pizza is being made',
    orderStatusReadyDesc: 'Order is ready',
    orderStatusOutForDeliveryDesc: 'On the way',
    orderStatusDeliveredDesc: 'Enjoy your meal!',
