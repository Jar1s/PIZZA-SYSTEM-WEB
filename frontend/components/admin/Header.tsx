    ...
    <header className="bg-white border-b border-gray-200 px-4 lg:px-6 py-3 flex-shrink-0 z-10" style={{ backgroundColor: '#ffffff', borderColor: '#e5e7eb' }}>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-base lg:text-lg font-semibold text-gray-900" style={{ color: '#111827' }}>{getPageTitle()}</h2>
        </div>
        <div className="flex items-center gap-2 lg:gap-4">
          ...
          />
          <div className="hidden sm:block text-sm text-gray-500" style={{ color: '#6b7280' }}>
