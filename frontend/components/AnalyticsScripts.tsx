...
export function AnalyticsScripts() {
  ...
  const analyticsConfig: AnalyticsConfig | undefined = theme.analyticsConfig;
  ...
  return (
    <>
      ...
      {/* Google Tag Manager */}
      {analyticsConfig.googleTagManager?.enabled && analyticsConfig.googleTagManager.containerId && (
        <>
      ...
      {/* TikTok Pixel */}
      {analyticsConfig.tiktokPixel?.enabled && analyticsConfig.tiktokPixel.pixelId && (
      ...
      {analyticsConfig.linkedinInsight?.enabled && analyticsConfig.linkedinInsight.partnerId && (
