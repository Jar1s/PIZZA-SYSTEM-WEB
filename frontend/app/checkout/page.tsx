...
export default function CheckoutPage() {
  ...
  return (
    // Slightly larger bottom padding on mobile so the last button clears the
    // minimised Safari bottom bar without leaving a big black gap.
    <div className={`min-h-screen ${backgroundClass} ${isDark ? 'text-white pt-10 pb-12 sm:pb-10' : 'pt-8 pb-12 sm:pb-8'}`}>
